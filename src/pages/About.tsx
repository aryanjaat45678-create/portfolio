...
<head>
    ...
    <title>ARYAN CHOUDHARY Resume</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="resume-wrapper">
            <!-- Header -->
            <div class="header">
                <img src="https://raw.githubusercontent.com/aryanjaat45678-create/portfolio/refs/heads/main/public/assets/aryan.png" alt="Aryan Choudhary" class="profile-photo">
                <div class="header-content">
                    <h1>Aryan Choudhary</h1>
                    <p class="title">Frontend Developer | AI </p>
                    <div class="contact-info">
                        <div class="contact-item">
                            <span class="contact-icon">🏠︎</span>
                            <span>Muzaffarnagar, UP, India</span>
                        </div>
                        <div class="contact-item">
                            <span class="contact-icon">✉︎</span>
                            <a href="mailto:aryanjaat45678@gmail.com">aryanjaat45678@gmail.com</a>
                        </div>
                        <div class="contact-item">
                            <span class="contact-icon">🆆</span>
                            <a href="https://portfolio-aryanchoudhary.vercel.app/" target="_blank">Portfolio Website</a>
                        </div>
                        <div class="contact-item">
                            <span class="contact-icon">⛆</span>
                            <a href="https://github.com/aryanjaat45678-create" target="_blank">aryanjaat45678-create</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <section class="section">
                    ...
                    <div class="education-item">
                        <h3>B.tech CSE AI</h3>
                        <p>Currently pursuing B.tech with CSE AI</p>
                    </div>
                </section>
                ...
                <section class="section">
                    ...
                    <div class="objective-box">
                        To build a successful career in the tech industry by continuously improving my skills in frontend development, and AI technologies while contributing to innovative and impactful projects.
                    </div>
                </section>
        ...
        a.href = url;
        a.download = "Aryan_Choudhary_Resume.html";
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen gap-8">
        ...
        >
          ...
          >
            ...
            >
              <p>
                I'm currently Pursuing my B.tech CSE AI. I started 
                getting more interested in computers and technology
                after join college. 
              </p>

              <p>
                In 1st year, I explored coding more seriously and slowly
                developed a strong interest in programming and AI.
              </p>
              ...
              <p>
                Out of everything in tech, AI&ML and Python interest 
                me the most because I find it exciting to learn about 
